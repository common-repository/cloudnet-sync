<?php
/**
 * Class CloudNetTransientAdminNotices
 *
 * Handles displaying admin notices in WordPress after a page redirect or reload.
 */
class CloudNetTransientAdminNotices implements \Countable, \IteratorAggregate {
	const TYPES = [
		'success',
		'info',
		'warning',
	...
	protected $transient;
	/**
	 * CloudNetTransientAdminNotices constructor.
	 *

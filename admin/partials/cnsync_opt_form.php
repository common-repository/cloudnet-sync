...
<div class="wrap">
    <div class="head_wrap">
        <h1 class="cn_title dashicons-before dashicons-cloud">CloudNet360 Forms</h1>
    </div>
    <div id="content">
        <h3 class="page_title">Shortcoder 
            <div class="cn_menu">
                <a href="<?php echo admin_url(); ?>admin.php?page=form" class="button cn_back_btn">
        ...
        <form method="post" id="cn_edit_form">
                ...
                <div class="cn_name_wrap">
                    ...
                    <?php if (isset($_GET['id']) != '') { ?>
                        <div class="copy_shortcode">
                            Your shortcode is - 
                            <strong>
                                <?php echo '[cn_opt_form id =' . $_GET['id'] . ']'; ?>
                            </strong>
                        </div>
                    <?php } else { ?>
            ...
            <div class="cn_section">
                <label for="cn_content">Add opt-in code below<span class="dashicons dashicons-info cn_note_btn" title="Put form data in below box."></span>
                </label>
            ...
            <footer class="page_footer">
                <input class="button button-primary cn_save" type="submit" name="cn_save" value="Save settings">
                <?php wp_nonce_field('cn_save_action', 'cn_create_form'); ?>
            </footer>
        </form>
    </div>
</div>